                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded detail">
                                    <a href="#">
                                        <img src="img/sayuran-3.png" class="img-fluid rounded" alt="Image">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h4 class="fw-bold mb-3">Cabai</h4>
                                <p class="mb-3">Kategori: Sayuran</p>
                                <h5 class="fw-bold mb-3">Rp. 80.000 / kg</h5>
                                ...
                                <form action="" method="post">
                                       ...
                                       <input type="hidden" name="barangID" value="2">
